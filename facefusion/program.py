...
def create_program() -> ArgumentParser:
	...
	sub_program.add_parser('doctor', help = translator.get('help.doctor'), parents = [ create_config_path_program(), create_temp_path_program(), create_jobs_path_program(), create_execution_program(), create_log_level_program() ], formatter_class = create_help_formatter_large)
